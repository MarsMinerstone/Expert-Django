...
(function(a) {
    ...
    function e(a, f) {
        ...
        if (!h)
            if (h = a && ("undefined" !== typeof Symbol && a[Symbol.iterator] || a["@@iterator"]), null == h)
                h = void 0;
            else {
                var c = [],
                    b = !0,
    ...
    b = function(a, b) {
        ...
        for (c; c < d; c += 1)
            ...
            (a[c].jarallax = new z(a[c], b)) : a[c].jarallax && (e = a[c].jarallax[b].apply(a[c].jarallax, g)), "undefined" !== typeof e)
                return e;
        return a
    };
    b.constructor = z;
