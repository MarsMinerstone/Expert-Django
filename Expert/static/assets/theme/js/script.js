...
$jscomp.polyfill("Array.from", function(b) {
    return b ? b : function(b, d, q) {
        ...
        if ("function" == typeof n) {
            b = n.call(b);
            for (var r = 0; !(n = b.next()).done;)
                h.push(d.call(q, n.value, r++))
        } else
            for (n = b.length, r = 0; r < n; r++)
...
(function() {
        ...
        if ("undefined" !== typeof jarallax && !v()) {
            ...
            if (p) {
                ...
                g(document).on("changeParameter.cards", function(a, b, f, e) {
                    if ("bg" === b)
                        switch (b = a.target, jarallax && jarallax(b, "destroy"), b.style.position = "", g(a.target).find(".mbr-background-video-preview").remove(), g(a.target).find(".mbr-background-video").remove(),
    ...
    if (!p && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./)))
        g(document).on("add.cards", function(a) {
            var b = a.target;
    ...
    if (p)
        ...
        document.querySelectorAll(".pie_progress").length && ("undefined" !== typeof CircularProgressBar &&
    ...
    if (p && t)
        ...
        "undefined" === typeof window.initTestimonialsPlugin && (window.initTestimonialsPlugin = !0, document.querySelectorAll(".testimonials-slider").forEach(function(a) {
            x(a)
        }));
    l(function() {
...
//         a.id = "top-1";
//         a.style = "display: none";
//         a.innerHTML = '<a href="https://mobiri.se/a8">Free Web Page Editor</a> Mobirise v5.6.11 <a href="https://mobirise.com/website-design-software.html">Web Site Design Software</a>';
